...
A token is a web authentication technique that is uniquely generated/encrypted in exchange whenever users enter their username and password once. This token is then used to access protected pages or resources instead of the login credentials for a designated period of time.
